export const usTexts = {
  ...
  home_status_loading: "Loading content...",
  home_status_empty: "No content available",
  home_status_error: "This block failed to load",
  home_status_retry: "Try again",
  home_status_loading_a11y: "Block is loading",
  home_status_empty_a11y: "Block without content",
  home_status_error_a11y: "Block with error",
