export const ptBRTexts = {
  ...
  home_status_loading: "Carregando conteúdo...",
  home_status_empty: "Nenhum conteúdo disponível",
  home_status_error: "Não foi possível carregar este bloco",
  home_status_retry: "Tentar novamente",
  home_status_loading_a11y: "Bloco carregando",
  home_status_empty_a11y: "Bloco sem conteúdo",
  home_status_error_a11y: "Bloco com erro",
